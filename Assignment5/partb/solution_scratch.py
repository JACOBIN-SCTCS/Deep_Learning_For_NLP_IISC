...
class T5Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        output_tokens_id_full = torch.zeros((self.output_max_token_length,))
        output_tokens_id = torch.tensor(output_vocabulary.forward(output_tokens))
...
class TransformerModel(nn.Module):
    ...
    def __init__(
        ...
        self.src_embedding = nn.Embedding.from_pretrained(bert_model.embeddings.word_embeddings,freeze=False)
...
class TransformerTranslator(pl.LightningModule):
    ...
    def training_step(self, batch_data,batch_idx):
        ...
        tgt_padding_mask = self.transformer.get_padding_mask(output_attention_mask,0)
